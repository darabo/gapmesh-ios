...
struct FragmentationTests {
    ...
    init() {
        ...
        idBridge = NostrIdentityBridge(keychain: mockKeychain)
    }
    ...
    func duplicateFragmentDoesNotBreakReassembly() async throws {
        ...
        // Send fragments sequentially with small delays
...
>>>>>>> 4b30771 (fix BCH-01-002: prevent DoS via file storage exhaustion)
    ...
    func invalidFragmentHeaderIsIgnored() async throws {
        ...
        // Allow small window for any processing
